...
def test_save_report_success(mock_file, mock_makedirs) -> None:
    ...
    expected_folder = os.path.join(project_root, "audit_reports", "quick_scan")
    expected_path = os.path.join(expected_folder, f"myrepo_{ddmmyy}_scan.md")
...
def test_save_deep_audit_report_success(mock_file, mock_makedirs) -> None:
    ...
    ddmmyy = datetime.datetime.now().strftime("%d%m%y")
    project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    expected_folder = os.path.join(project_root, "audit_reports", "deep_audit")
